...
4. Partitions via
   ...
   (`cross_chunk_links/+delta/kK/`, one cell per sorted-unique-chunks
   tuple in the appropriate K-sub-array) buckets — see the
   [sharded cross-chunk-link layout](../object_model/cross_chunk_links.md).
